            ...
            <div class="brand-slider-wrapper overflow-hidden">
                <div class="brand-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        ...
                        {# 1 - Mahala #}
                        <div class="swiper-slide me-0 tw-py-4 border tw-border-dashed border-neutral-200 border-top-0 tw-h-114-px border-end-0 tw-px-6 d-flex justify-content-center align-items-center">
                            <div class="text-center d-flex align-items-center justify-content-center" style="height:90px;">
                                <img alt="Mahala" src="https://res.cloudinary.com/ddnxhn442/image/upload/v1774021766/Mahala_tiirqf.jpg"
                                    style="max-height:80px;max-width:160px;width:auto;object-fit:contain;display:block;margin:auto;" />
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide me-0 tw-py-4 border tw-border-dashed border-neutral-200 border-top-0 tw-h-114-px border-end-0 tw-px-6 d-flex justify-content-center align-items-center">
                            <div class="text-center d-flex align-items-center justify-content-center" style="height:90px;">
                                <img alt="GRT Hotels and Resorts" src="https://res.cloudinary.com/ddnxhn442/image/upload/v1774021765/GRT_Hotels_and_Resorts_Logo_vzrbp4.avif"
                                    style="max-height:80px;max-width:160px;width:auto;object-fit:contain;display:block;margin:auto;" />
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide me-0 tw-py-4 border tw-border-dashed border-neutral-200 border-top-0 tw-h-114-px border-end-0 tw-px-6 d-flex justify-content-center align-items-center">
                            <div class="text-center d-flex align-items-center justify-content-center" style="height:90px;">
                                <img alt="Client Logo" src="https://res.cloudinary.com/ddnxhn442/image/upload/v1774021765/images_csnzvx.png"
                                    style="max-height:80px;max-width:160px;width:auto;object-fit:contain;display:block;margin:auto;" />
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide me-0 tw-py-4 border tw-border-dashed border-neutral-200 border-top-0 tw-h-114-px border-end-0 tw-px-6 d-flex justify-content-center align-items-center">
                            <div class="text-center d-flex align-items-center justify-content-center" style="height:90px;">
                                <img alt="Zebu" src="https://res.cloudinary.com/ddnxhn442/image/upload/v1774021765/Zebu---akkurate_lj8fq5.png"
                                    style="max-height:80px;max-width:160px;width:auto;object-fit:contain;display:block;margin:auto;" />
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide me-0 tw-py-4 border tw-border-dashed border-neutral-200 border-top-0 tw-h-114-px border-end-0 tw-px-6 d-flex justify-content-center align-items-center">
                            <div class="text-center d-flex align-items-center justify-content-center" style="height:90px;">
                                <img alt="Vivaaha" src="https://res.cloudinary.com/ddnxhn442/image/upload/v1774021764/vivaaha---Akkurate_qeubmf.png"
                                    style="max-height:80px;max-width:160px;width:auto;object-fit:contain;display:block;margin:auto;" />
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide me-0 tw-py-4 border tw-border-dashed border-neutral-200 border-top-0 tw-h-114-px border-end-0 tw-px-6 d-flex justify-content-center align-items-center">
                            <div class="text-center d-flex align-items-center justify-content-center" style="height:90px;">
                                <img alt="Six Bash League" src="https://res.cloudinary.com/ddnxhn442/image/upload/v1774021764/Six-bash-League-A---Akkurate_rmwnzj.png"
                                    style="max-height:80px;max-width:160px;width:auto;object-fit:contain;display:block;margin:auto;" />
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide me-0 tw-py-4 border tw-border-dashed border-neutral-200 border-top-0 tw-h-114-px border-end-0 tw-px-6 d-flex justify-content-center align-items-center">
                            <div class="text-center d-flex align-items-center justify-content-center" style="height:90px;">
                                <img alt="Tails" src="https://res.cloudinary.com/ddnxhn442/image/upload/v1774021764/Tails--Akkurate_ysgxfm.png"
                                    style="max-height:80px;max-width:160px;width:auto;object-fit:contain;display:block;margin:auto;" />
                            </div>
                        </div>


                        {# 9 - Client 9 (sky blue background) #}
                        <div class="swiper-slide me-0 tw-py-4 border tw-border-dashed border-neutral-200 border-top-0 tw-h-114-px border-end-0 tw-px-6 d-flex justify-content-center align-items-center">
                            <div class="text-center d-flex align-items-center justify-content-center" style="height:90px;">
                                <div style="background-color:#56c5e0;border-radius:12px;padding:10px 18px;display:inline-flex;align-items:center;justify-content:center;height:80px;">
                                    <img alt="Client Logo" src="https://res.cloudinary.com/ddnxhn442/image/upload/v1774021763/5_axamcs.png"
                                        style="max-height:60px;max-width:140px;width:auto;object-fit:contain;display:block;" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide me-0 tw-py-4 border tw-border-dashed border-neutral-200 border-top-0 tw-h-114-px border-end-0 tw-px-6 d-flex justify-content-center align-items-center">
                            <div class="text-center d-flex align-items-center justify-content-center" style="height:90px;">
                                <img alt="FM Logo" src="https://res.cloudinary.com/ddnxhn442/image/upload/v1774021764/FM_logo_xefezr.png"
                                    style="max-height:80px;max-width:160px;width:auto;object-fit:contain;display:block;margin:auto;" />
                            </div>
                        </div>
