                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="text-center">
                                ...
                                <h1 class="mb-0 splitTextStyleOne text-capitalize"> Checkout</h1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row gy-5">
                        <div class="col-xxl-8 col-lg-7">
                            <div class="">
                                <h6 class="tw-mb-8">Delivery Information</h6>
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="position-relative">
                                                <input
                                                    class="form-control bg-neutral-100 border border-neutral-100 focus-border-main-600 text-neutral-500 fw-medium tw-px-6 tw-py-4 tw-pe-15 tw-rounded-lg shadow-none"
                                                    placeholder="Address here" type="text" />
                                                <span
                                                    class="tw-text-xl text-main-600 d-flex tw-leading-none position-absolute top-50 translate-middle-y tw-end-0 tw-me-6">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="position-relative">
                                                <input
                                                    class="form-control bg-neutral-100 border border-neutral-100 focus-border-main-600 text-neutral-500 fw-medium tw-px-6 tw-py-4 tw-pe-15 tw-rounded-lg shadow-none"
                                                    placeholder="House Number &amp; street number" type="text" />
                                                <span
                                                    class="tw-text-xl text-main-600 d-flex tw-leading-none position-absolute top-50 translate-middle-y tw-end-0 tw-me-6">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="position-relative">
                                                <input
                                                    class="form-control bg-neutral-100 border border-neutral-100 focus-border-main-600 text-neutral-500 fw-medium tw-px-6 tw-py-4 tw-pe-15 tw-rounded-lg shadow-none"
                                                    placeholder="Apartment, suit, Unit etc" type="text" />
                                                <span
                                                    class="tw-text-xl text-main-600 d-flex tw-leading-none position-absolute top-50 translate-middle-y tw-end-0 tw-me-6">
                                                    <i class="ph-fill ph-map-pin"></i>
                                                </span>
                                        ...
                                        <div class="col-sm-12">
                                            <button
                                                ...
                                                <span class="button__label">Save All Information</span>
                                            </button>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="col-xxl-4 col-lg-5">
                            <div class="">
                                <h5 class="text-center tw-text-2xl tw-mb-10">Order Summery</h5>
                                <div class="bg-neutral-100 tw-py-16 tw-px-11 tw-rounded-lg">
                                    <div class="d-flex flex-column tw-gap-7">
                                        <div
                                            ...
                                            <span
                                                class="fw-bold tw-text-base text-capitalize text-heading">$345.00</span>
                                        </div>
                                        <div
                                            class="tw-rounded-md tw-py-3 tw-px-6 text-neutral-600 d-flex align-items-center justify-content-between bg-white">
                                            <span class="fw-semibold tw-text-base text-capitalize">Shipping Fee</span>
                                            <span
                                                class="fw-bold tw-text-base text-capitalize text-heading">$34.00</span>
                                        </div>
                                        <div class="">
                                            <form action="#" class="form-submit position-relative">
                                                <input
                                                    ...
                                                    placeholder="Enter voucher Code" type="text" />
                                                <button
                                    ...
                                    <div class="">
                                        <div class="bg-white tw-rounded-xl tw-p-705 d-flex flex-column tw-gap-305">
                                            <div class="form-check common-check common-radio tw-gap-3 mb-0">
                                                <input class="form-check-input bg-neutral-200" id="bankTransfer"
                                                    name="paymentOption" type="radio" />
                                                <label class="form-check-label fw-medium text-heading"
                                                    for="bankTransfer">Direct Bank transfer</label>
                                            </div>
                                            <div class="form-check common-check common-radio tw-gap-3 mb-0">
                                                <input class="form-check-input bg-neutral-200" id="CheckPayments"
                                                    name="paymentOption" type="radio" />
                                                <label class="form-check-label fw-medium text-heading"
                                                    for="CheckPayments">Check Payments</label>
                                            </div>
                                            <div class="form-check common-check common-radio tw-gap-3 mb-0">
                                                <input class="form-check-input bg-neutral-200" id="CashOnDelivery"
                                                    name="paymentOption" type="radio" />
                                                <label class="form-check-label fw-medium text-heading"
