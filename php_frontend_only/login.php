                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="text-center">
                                ...
                                <h1 class="mb-0 splitTextStyleOne text-capitalize"> Sign In</h1>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="max-w-514-px bg-white common-shadow-twentyOne tw-rounded-2xl tw-p-60-px mx-auto">
                        ...
                        <form action="#" class="form-submit d-flex flex-column tw-gap-6">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="common-check d-flex align-items-center tw-gap-2 mb-0">
                                    <input class="form-check-input" id="remember" type="checkbox" />
                                    <div class="form-check-label text-neutral-600 fw-medium">
                                        <label class="" for="remember">Remember me</label>
                                    </div>
                                </div>
                                <a class="hover-underline text-danger fw-semibold hover--translate-y-1 active-scale-09"
