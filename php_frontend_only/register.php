                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="text-center">
                                ...
                                <h1 class="mb-0 splitTextStyleOne text-capitalize"> Sign Up</h1>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="account py-120">
                <div class="container">
                    <div class="max-w-514-px bg-white common-shadow-twentyOne tw-rounded-2xl tw-p-60-px mx-auto">
                        <h4 class="tw-mb-8 text-capitalize fst-italic fw-bold text-center max-w-250-px mx-auto">Start
                            Your
                            Journey with us</h4>
                        <form action="#" class="form-submit d-flex flex-column tw-gap-6">
                            <div class="">
                                <label class="fw-semibold text-heading d-block tw-mb-105" for="name">Enter your
                                    name</label>
                                <input
                            ...
                            <div class="">
                                <label class="fw-semibold text-heading d-block tw-mb-105"
                                    for="username">Username</label>
                                <input
                                    class="form-control bg-neutral-100 border border-neutral-100 focus-border-main-600 text-heading fw-medium tw-px-6 tw-py-4 tw-rounded-lg shadow-none"
                                    id="username" placeholder="Enter username" type="text" />
                            </div>
                            <div class="">
                                <label class="fw-semibold text-heading d-block tw-mb-105" for="enterEmail">Enter your
                                    email</label>
                                <input
                                    class="form-control bg-neutral-100 border border-neutral-100 focus-border-main-600 text-heading fw-medium tw-px-6 tw-py-4 tw-rounded-lg shadow-none"
                                    id="enterEmail" placeholder="Enter your email" type="email" />
                            </div>
                            <div class="">
                                <label class="fw-medium text-base text-neutral-800 tw-mb-3" for="createPassword"> Create
                                    password</label>
                                <div class="position-relative">
                                    <input
                                        class="form-control bg-neutral-100 border border-neutral-100 focus-border-main-600 text-heading fw-medium tw-px-6 tw-py-4 tw-rounded-lg shadow-none"
                                        id="createPassword" placeholder="Enter your name" type="text" />
                                    <span
                                        ...
                                        id="#createPassword"></span>
                                </div>
                            </div>
                            <div class="">
                                <label class="fw-medium text-base text-neutral-800 tw-mb-3"
                                    for="confirmPassword">Confirm
                                    Password</label>
                                <div class="position-relative">
                                    <input
                                        class="form-control bg-neutral-100 border border-neutral-100 focus-border-main-600 text-heading fw-medium tw-px-6 tw-py-4 tw-rounded-lg shadow-none"
                                        id="confirmPassword" placeholder="Enter your name" type="text" />
                                    <span
                                        class="toggle-password position-absolute top-50 tw-end-0 tw-me-4 tw-text-xl text-neutral-600 tw--translate-y-50 ph-bold ph-eye-slash"
                                        id="#confirmPassword"></span>
                                </div>
                            </div>
                            <div class="common-check d-flex align-items-center tw-gap-2">
                                <input class="form-check-input" id="remember" type="checkbox" />
                                <div class="form-check-label text-neutral-600 fw-semibold">
                                    <label class="" for="remember"> I agree to sassly</label>
                                    <a class="text-decoration-underline text-neutral-600 fw-semibold hover--translate-y-1 active-scale-09 hover-text-main-600"
